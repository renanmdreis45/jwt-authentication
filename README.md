# Login authentication with JWT, TypeScript, React, Redux, Node, Express and Prisma
...
<p>
Login and registration screen with jwt authentication. Developed in React, Redux, Node, Express and Prisma.
</p>
...
<p> The following technologies were used in the project</p>
<ul>
 <li> TypeScript </li>
 <li> React </li>
 <li> Redux </li>
